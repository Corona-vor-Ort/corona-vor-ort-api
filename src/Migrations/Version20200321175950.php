 ...
 */
final class Version20200321175950 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE meldung DROP meldung_id, CHANGE bbk_identifier bbk_identifier VARCHAR(63) DEFAULT NULL, CHANGE more_information_link more_information_link VARCHAR(511) DEFAULT NULL, CHANGE severity severity INT DEFAULT NULL, CHANGE meldende_stelle meldende_stelle VARCHAR(127) DEFAULT NULL');
